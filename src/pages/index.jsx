...
import { Button, LanguageButton, Form } from "../components";
		...
		<main className="main">
			...
			<header className="header">
				<div className="header__language">
					<LanguageButton type="button" disabled>
						Eng
					</LanguageButton>{" "}
					| <LanguageButton type="button">Rus</LanguageButton>
				</div>
				<h1 className="header__title">Build your startup for 200$ per week?</h1>
			...
			<section className="section">
				...
				<p className="section__text">
					lambda.direct - is a team(40 people) of highly experienced backend and frontend
					developers. We have an ongoing flow of hiring and teaching new developers. Here you can
					hire them at an extremely low rate so they can build projects for you while they’re
					actively learning and get mentored by a highly experienced engineers.
				</p>
			</section>
			<section className="section">
			...
			<section className="section">
				...
				<ul>
					<li>
						ReactJs / NextJs / GatsbyJS / VueJs. It can be a landing page with a static, multipage
						website or an admin panel with a fully dynamic content.
					</li>
			...
			<section className="section">
				...
				<ul>
					...
					<li>
						Micro-services on AWS with DynamoDB, S3, Cognito, API gateway and Lambdas using
						ServerlessJs
					</li>
			...
			<section className="section">
				...
				<p className="section__text">
					💡If you need to build both website and a backend with database for storing and providing
					user data with REST apis — you’ll need 1 frontend trainee and 1 backend trainee, it’ll
					cost you <b>400$</b> per week.
				</p>
			</section>
			<Form />
		</main>
